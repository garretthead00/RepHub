...
class FollowingViewController: UIViewController {
    ...
    private func loadFollowing(){
        ...
        API.Follow.fetchFollowing(forUserId: currentUser.uid, completion: {
            user in
...
extension FollowingViewController: DiscoverUserCellDelegate {
...
extension FollowingViewController: UserLockerDelegate {
